describe Gateways::PullRequest do
  REVIEW_REQUIRED_URL = 'https://api.github.com/search/issues?per_page=100&q=is:pr+user:alphagov+topic:govuk+state:open+author:app/dependabot+review:required'.freeze
  APPROVED_URL = 'https://api.github.com/search/issues?per_page=100&q=is:pr+user:alphagov+topic:govuk+state:open+author:app/dependabot+review:approved'.freeze
  CHANGES_REQUESTED_URL = 'https://api.github.com/search/issues?per_page=100&q=is:pr+user:alphagov+topic:govuk+state:open+author:app/dependabot+review:changes_requested'.freeze
