...
describe Dependapanda do
  ...
  context "Simple Message" do
    it "sends a summarised message" do
      modelling_services_payload = {
        "payload" => '{"channel":"modelling-services","username":"Depandabot","icon_emoji":":panda_face:","text":"You have 2 open Dependabot PR(s) - https://govuk-dependencies.herokuapp.com/team/modelling-services"}',
      }

      start_pages_payload = {
        "payload" => '{"channel":"start-pages","username":"Depandabot","icon_emoji":":panda_face:","text":"You have 1 open Dependabot PR(s) - https://govuk-dependencies.herokuapp.com/team/start-pages"}',
      }
  ...
  context "Full Message" do
    it "sends all the pull requests in the message" do
      modelling_services_payload = {
        "payload" => '{"channel":"modelling-services","username":"Depandabot","icon_emoji":":panda_face:","text":"<https://govuk-dependencies.herokuapp.com/team/modelling-services|modelling-services> have 2 Dependabot PRs open on the following apps:\n\n<https://github.com/alphagov/publisher/pulls/app/dependabot-preview|publisher> (2)"}',
      }

      start_pages_payload = {
        "payload" => '{"channel":"start-pages","username":"Depandabot","icon_emoji":":panda_face:","text":"<https://govuk-dependencies.herokuapp.com/team/start-pages|start-pages> have 1 Dependabot PRs open on the following apps:\n\n<https://github.com/alphagov/frontend/pulls/app/dependabot-preview|frontend> (1)"}',
      }
