describe UseCases::Cache do
  context 'Given the result has not been cached' do
    it 'caches the result' do
      ...
      described_class.new(path: 'foo', file: file).execute do
        'some cached result'
      end
    end
    ...
    it 'returns the result' do
      ...
      result = described_class.new(path: 'foo', file: file).execute do
        'some cached result'
      end
  ...
  context 'Given the result has been previously cached' do
    it 'returns the cached result' do
      ...
      result = described_class.new(path: 'foo.html', file: file).execute {}
